...
.factory('taskSortable', function(){
	var taskSortable = {
		sortableOptions : {
			...
			axis: 'y',
			helper : getSortHelper, // postion:absolute ÅÌÉúêÏÑú diplay:table-cell ïÏÉÅ úÏãú àÎêòÎ¨∏Ï†ú ¥Í≤∞
			// start  : onSortStarted,
...
.controller('TasksController', ['$scope', '$location', '$routeParams', 'Tasks', 'taskSortable', function ($scope, $location, $routeParams, Tasks, taskSortable) {
	...
	// wbs Í∏∞ÏºÎ°ú sorting òÍ∏∞
	// angular úÍ≥µòÎäî sortcompare Î∞©ÏãùÑÎãàºÏÑú
	// Í∞level Î≥úÍ≥±òÎ îÌïòsorting 
